 ...
 *   curl -s "https://ppj.jurnalsinta.id/cron/cron_scan_judol.php?token=CRON_TOKEN_VALUE"
 *
 ...
 *   0 2,8,14,20 * * * curl -s "https://ppj.jurnalsinta.id/cron/cron_scan_judol.php?token=XXX" > /dev/null 2>&1
 *
